...
@section('content')
    ...
    @if ($page_filter != null)
        ...
        @if(in_array('products', $page_filter))
        ...
        @if(in_array('limited_offers', $page_filter))
        ...
        @if(in_array('categories', $page_filter))
        ...
        @if(in_array('subscribe_area', $page_filter))
