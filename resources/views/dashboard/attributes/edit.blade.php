            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('attributes.update', $attribute->id) }}">
                    ...
                    <div class="form-group">
                        <label for="name"> Attribute / {{ trans('admin.name') }}</label>
                        <input type="text" id="name" name="name" class="form-control" placeholder="Attribute / {{ trans('admin.name') }}..." value="{{ $attribute->name }}">
                    </div>
