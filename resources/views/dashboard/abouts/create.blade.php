            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('about.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="desc" type="text" name="title" class="form-control" placeholder="{{ trans('admin.about') }} / {{ trans('admin.title') }}..." value="{{ old('title') }}">
                    </div>

                    <div class="form-group">
                        <label for="desc"> {{ trans('admin.about') }} / {{ trans('admin.description') }}</label>
                        <textarea id="desc" name="description" rows="4" class="form-control" placeholder="{{ trans('admin.about') }} / {{ trans('admin.description') }}...">{{ old('description') }}</textarea>
                    </div>
