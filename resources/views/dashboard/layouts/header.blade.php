                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div id="notifications_menu" class="dropdown-menu dropdown-menu-right navbar-notifications-menu">
                            ...
                            <div class="navbar-notifications-menu__content" data-perfect-scrollbar>
                                @php
                                    $notifications = \App\Models\ContactNotification::where('status', '0')
                                        ->orderBy('id', 'desc')
                                        ->limit(10)
                                        ->get();
                                @endphp
                ...
                <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                    <li class="nav-item dropdown">
                        <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">
                            ...
                            @if(auth()->user()->image)
                                <img src="{{ auth()->user()->user_image  }}" class="rounded-circle" width="32" alt="User Image">
                            @else
                                <img src="https://avatars.abstractapi.com/v1/?api_key=1768dfbe3071477eb60bad2f86703a2c&name={{ auth()->user()->name }}" alt="User Avatar" width="32" class="rounded-circle">
                            @endif
                        </a>
