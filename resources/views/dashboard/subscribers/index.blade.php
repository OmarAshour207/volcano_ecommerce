                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('admin.subscribers') }}</li>
                        </ol>
                    </nav>
                    <h1 class="m-0"> {{ trans('admin.subscribers') }} </h1>
                </div>
                <a href="{{ route('subscribers.create') }}" class="btn btn-success ml-3">{{ trans('admin.create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        <thead>
                            ...
                            <th style="width: 120px;" > {{ trans('admin.email') }} </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('subscribers.edit', $subscriber->id) }}" class="btn btn-sm btn-link">
