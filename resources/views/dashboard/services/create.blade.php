            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('services.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="title" name="title" type="text" class="form-control" placeholder="{{ trans('admin.title') }}" value="{{ old('title') }}">
                    </div>

                    <div class="form-group">
                        <label for="desc"> {{ trans('admin.services') }} / {{ trans('admin.description') }}</label>
                        <textarea id="desc" name="description" rows="4" class="form-control" placeholder="{{ trans('admin.services') }} / {{ trans('admin.description') }}...">{{ old('description') }}</textarea>
                    </div>
