            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('slider.update', $slider->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="en_title" rows="4" class="form-control" placeholder="{{ trans('admin.slider') }} / {{ trans('admin.title') }}..." value="{{ $slider->title }}">
                    </div>

                    <div class="form-group">
                        <label for="desc"> {{ trans('admin.slider') }} / {{ trans('admin.description') }}</label>
                        <textarea id="desc" name="description" rows="4" class="form-control" placeholder="{{ trans('admin.slider') }} / {{ trans('admin.description') }}...">{{ $slider->description }}
                        </textarea>
                    </div>
