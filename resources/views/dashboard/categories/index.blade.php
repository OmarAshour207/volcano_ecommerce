                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('admin.contact_us') }}</li>
                        </ol>
                    </nav>
                    <h1 class="m-0"> {{ trans('admin.categories') }} </h1>
                </div>
                <a href="{{ route('categories.create') }}" class="btn btn-success ml-3">{{ trans('admin.create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-sm btn-link">
