        ...
        <div class="container-fluid page__heading-container">
            <div class="page__heading d-flex align-items-center">
                <div class="flex">
                    ...
                    <h1 class="m-0"> {{ trans('admin.offer') }} </h1>
                </div>
            </div>
        </div>
            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('offers.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="value"> {{ trans('admin.offer') }} / {{ trans('admin.value') }}</label>
                        <input type="number" id="value" name="value" class="form-control" placeholder="{{ trans('admin.offer') }} / {{ trans('admin.value') }}..." value="{{ old('value') }}">
                    </div>
                    <div class="form-group">
                        <label for="title"> {{ trans('admin.offer') }} / {{ trans('admin.title') }}</label>
                        <input type="text" id="title" name="title" class="form-control" placeholder="{{ trans('admin.offer') }} / {{ trans('admin.title') }}..." value="{{ old('title') }}">
                    </div>
